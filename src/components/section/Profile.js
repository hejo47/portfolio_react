        ...
        <div className={classes.profile}>
          ...
          <div className={classes.profileText}>
            ...
            <div className={classes.left}>
              <h3>교육수료 및 경력</h3>
              <p data-aos='fade-down' data-aos-duration='1000' data-aos-delay='500'>
                2021년 12월 ~ 2022년 08월 <span>이엑스마루 퍼블리셔 근무</span>
              </p>
              <div className={classes.lineWrap}>
                <div className={classes.line} data-aos='fade-down' data-aos-duration='1000' data-aos-delay='1000'></div>
              </div>
