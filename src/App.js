...
const portfoioList = [
  ...
  },
  {
    ...
    desc_d: "가구 브랜드인 퍼니쳐입니다. 상품은 모두 Node Express를 사용해서 DB에 저장된 데이터를 Axios로 불러왔습니다. UI는 부분적으로 앤트 디자인을 차용했으며 팀 작업물로서 팀원간의 의사소통도 중요했던 제작물입니다.",
    score: "25%",
  },
  {
    text: "카카오 뉴스",
    ...
    desc_d: "카카오 뉴스 페이지입니다. 리액트를 공부하며 제작했던 웹인만큼 보이는 모습에 집중했고, 라우트를 사용해 메인화면에는 날짜를 넣었습니다.",
    score: "100%",
  },
  {
    text: "레인보우 식스 시즈",
    ...
    desc_d: "SCSS를 사용한 레인보우 식스 시즈 이벤트 홈페이지입니다. 눈 내리는 애니메이션을 SCSS를 사용해 넣었으며 반응형으로 제작했습니다.",
    score: "100%",
  },
  {
    text: "뺏슈",
    ...
    desc_d: "빵 쇼핑몰인 뺏슈입니다. '슈가(설탕)를 뺐다' 라는 뜻에서 나온 뺏슈는 당뇨 인구를 위한 무가당 빵을 팔고 있습니다. 제품 상세 페이지에는 OPEN API를 사용한 제품성분표를 제작했습니다. UI는 부트스트랩의 그리드 시스템을 차용했습니다.",
    score: "25%",
  },
  {
    text: "이케아",
